...
This toolkit documents the working map integration system used by Fanmake Pokémon Maps 5.0. It is organized so a contributor can start with a small map test, understand the tracker format, then add a complete game integration.
